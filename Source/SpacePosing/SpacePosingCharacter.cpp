...
void ASpacePosingCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void ASpacePosingCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	UE_LOG(LogTemp, Warning, TEXT("ASpacePosingCharacter::SetupPlayerInputComponent"));
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASpacePosingCharacter::Move);
...
void ASpacePosingCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASpacePosingCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
